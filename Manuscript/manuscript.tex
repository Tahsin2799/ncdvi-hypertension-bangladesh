...
\textbf{Availability of data and materials.} The BDHS 2017-18 and BDHS 2022 datasets are available from The DHS Program (\url{https://dhsprogram.com}) upon registration and approval of a research request. The analysis code that reproduces all results, tables, and figures in this manuscript is openly archived on Zenodo (\url{https://doi.org/10.5281/zenodo.20719301}) and developed at \url{https://github.com/Tahsin2799/ncdvi-hypertension-bangladesh}.
...
\section*{Appendix A. Analytical Process and Project Timeline}\label{appendix-a.-analytical-process-and-project-timeline}
\addcontentsline{toc}{section}{Appendix A. Analytical Process and Project Timeline}
...
\textbf{Table B.2. MCA design alternatives.} Each row varies a single design choice. The Phase 5 production specification is the first row.
