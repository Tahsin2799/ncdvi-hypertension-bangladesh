...
\urlstyle{same}
\hypersetup{
  pdfkeywords={hypertension; non-communicable diseases; vulnerability index; multiple correspondence analysis; multilevel logistic regression; Bangladesh; BDHS; external validation},
  colorlinks=true,
  linkcolor={black},
  filecolor={Maroon},
  citecolor={blue},
