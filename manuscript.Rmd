...
**Availability of data and materials.** The BDHS 2017-18 and BDHS 2022 datasets are available from The DHS Program (https://dhsprogram.com) upon registration and approval of a research request. The analysis code that reproduces all results, tables, and figures in this manuscript is openly archived on Zenodo (https://doi.org/10.5281/zenodo.20719300) and developed at https://github.com/Tahsin2799/ncdvi-hypertension-bangladesh.
...
# Appendix A. Summary of Analytical Development {.unnumbered}
...
**Table B.2. MCA design alternatives.** Each row varies a single design choice. The production specification is the first row.
...
# Appendix E. STROBE Reporting Checklist {.unnumbered}
